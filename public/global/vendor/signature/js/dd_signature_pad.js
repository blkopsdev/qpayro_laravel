...
var baseURL = "http://mydev.qpaypro.com";
// Path to images
var dd_imgPath = "/global/vendor/signature/images/dd_signature_pad";
...
// Save button name
var dd_objSaveButtonName = "Autorizar Firma";
// Signature output to image file name
var dd_outputFileName = Math.floor((Math.random() * 100000) + 1);
// Data processor location file + path
var dd_dataProcessURL = "/global/vendor/signature/dd_signature_process.php";
...
var dd_baseCanvas = {
	...
	'shadowblur' : 0,				// Drawing line shadow shadow blur (FF browsers)
