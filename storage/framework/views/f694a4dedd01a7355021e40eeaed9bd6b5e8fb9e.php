...
<div class="page-header">
  <h1 class="page-title font_lato">Merchant</h1>
...
<div class="btn-group">
<a href="<?php echo e(URL::to('merchant-register')); ?>" class="btn btn-outline btn-default" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo e(trans('app.add_user')); ?>"><i class="icon fa-plus" aria-hidden="true"></i> Nuevo Merchant</a>
</div>
</div>

<div class="btn-group">
	<form class="form-inline ng-pristine ng-valid" action="<?php echo e(URL::to('merchant')); ?>" method="get">
	   ...
	   <a href="<?php echo e(URL::to('merchant')); ?>" class="btn btn-outline btn-danger" type="button">
...
<table class="tablesaw table-striped table-bordered tablesaw-columntoggle" data-tablesaw-mode="columntoggle" data-tablesaw-minimap="" id="table-3973">
  <thead>
    <tr>
      ...
      <th data-tablesaw-priority="4">Codigo</th>
      <th data-tablesaw-priority="3">Logo</th>
  ...
  <?php $__currentLoopData = $merchant; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $view): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr>
      <td class="tablesaw-priority-6 tablesaw-cell-visible"><?php echo e($view->name); ?></td>
      <td class="tablesaw-priority-5"><?php echo e($view->code); ?></td>
      <td class="tablesaw-priority-4"><?php if(!empty($view->logo)): ?>
          <img src="<?php echo e(asset('uploads')); ?>/<?php echo e($view->logo); ?>">
          <?php else: ?>
              <img src="<?php echo e(URL::to('uploads/default.png')); ?>">
          <?php endif; ?>
    ...
    <?php endif; ?>
      ...
      <a title="<?php echo e(trans('app.edit')); ?>" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo e(trans('app.edit')); ?>" class="btn btn-icon btn-info btn-outline btn-round" href="<?php echo e(URL::to('mechant_edit',$view->mechant_id)); ?>"><i class="icon wb-pencil" aria-hidden="true"></i> </a>
<?php if(Auth::user()->hasRole('Admin')): ?>
      <button data-placement="top" data-toggle="modal" rel="tooltip" title="<?php echo e(trans('app.delete')); ?>"  data-original-title="<?php echo e(trans('app.delete')); ?>"  class="btn btn-icon btn-danger btn-outline btn-round" data-target=".exampleNiftyFlipVertical"  type="button" data-href="<?php echo e(URL::to('merchant_destroy',$view->mechant_id)); ?>"><i class="icon fa-remove" aria-hidden="true"></i></button>
      <?php endif; ?>
      </td>
    </tr>
