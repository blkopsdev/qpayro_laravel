...
<?php if($settingdata): ?>
	...
	<div class="page-content vertical-align-middle" style="background: rgba(40, 41, 41, 0.77);">
      <div class="brand">
	  <img class="navbar-brand-logo" style="height:50px" src="<?php echo e(URL::to('/')); ?>/uploads/<?php echo e($view->logo); ?>" />
      ...
      <?php endif; ?>
						<input id="email" type="username" class="form-control" placeholder="<?php echo e(trans('app.username')); ?> ó <?php echo e(trans('app.email_address')); ?> " name="email" value="<?php echo e(old('email')); ?>" required>
