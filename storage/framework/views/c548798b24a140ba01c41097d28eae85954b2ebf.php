<?php $__env->startSection('content'); ?>
 <link rel="stylesheet" href="<?php echo e(URL::to('/')); ?>/global/vendor/owl-carousel/owl.carousel.css">
  <link rel="stylesheet" href="<?php echo e(URL::to('/')); ?>/global/vendor/slick-carousel/slick.css">
 <link rel="stylesheet" href="<?php echo e(URL::to('/')); ?>/assets/examples/css/uikit/carousel.css">
              ...
              <div class="example-wrap">
                ...
                <div class="example">
                  <div class="slider" id="exampleLazy">
                    <div>
                      <img class="img-responsive" alt="..." data-lazy="<?php echo e(URL::to('/')); ?>/global/photos/placeholder.png"
                      />
                    </div>
                    <div>
                      <img class="img-responsive" alt="..." data-lazy="<?php echo e(URL::to('/')); ?>/global/photos/placeholder.png"
