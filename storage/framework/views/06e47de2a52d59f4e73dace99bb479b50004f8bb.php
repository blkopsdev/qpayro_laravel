...
<div class="page-header">
  ...
  <ol class="breadcrumb">
		...
		<?php if(Auth::user()->hasRole('Admin')): ?><li><a href="<?php echo e(URL::to('show')); ?>/<?php echo e($userdata->id); ?>"><?php echo e($userdata->first_name); ?> <?php echo e($userdata->last_name); ?></a></li><?php endif; ?>
	  ...
	  <!-- Example Basic Form -->
			...
			<div class="row">
			  ...
			  <div class="form-group col-sm-6">
				...
				<input type="text" class="form-control" id="phone" name="phone" placeholder="<?php echo e(trans('app.phone')); ?>" value="<?php echo e($userdata->email); ?>" autocomplete="off">
			  </div>
			</div>
			<div class="row">
			  <div class="form-group col-sm-6">
