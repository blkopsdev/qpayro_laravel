...
<div class="page-header">
  ...
  <ol class="breadcrumb">
		...
		<li><a href="<?php echo e(URL::to('business_products_detail', $business->business_id)); ?>">Lista de botónes</a></li>
...
<form  name="userForm" action="<?php echo e(URL::to('business_products_store')); ?>" method="post" enctype="multipart/form-data">
	  ...
	  <!-- Example Basic Form -->
        ...
        <div class="row">
          ...
          <div class="form-group col-sm-6">
            ...
            <div class="btn-group" data-toggle="buttons" role="group">
              <label class="btn btn-outline btn-primary  <?php echo e('active'); ?>" onclick="document.getElementById('price_range').disabled = false;">
        ...
        <div class="row">
          ...
          <div class="btn-group" data-toggle="buttons" role="group">
          <label class="btn btn-outline btn-primary  <?php echo e('active'); ?>" onclick="document.getElementById('charge_shipping').disabled = false;">
