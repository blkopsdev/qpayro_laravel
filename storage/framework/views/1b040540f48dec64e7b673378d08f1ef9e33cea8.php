...
<table class="tablesaw table-striped table-bordered tablesaw-columntoggle" data-tablesaw-mode="columntoggle" data-tablesaw-minimap="" id="table-3973">
		<thead>
		  <tr>
			  ...
			  <th data-tablesaw-priority="4"><?php echo e(trans('app.start_date')); ?></th>
			   <th data-tablesaw-priority="4"><?php echo e(trans('app.end_date')); ?></th>
		...
		<?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $view): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<tr>
			  <td class="tablesaw-priority-5 tablesaw-cell-visible"><?php echo e($view->title); ?></td>
             
			  <td class="tablesaw-priority-3"><?php echo e($view->category); ?></td>
			  <td class="tablesaw-priority-3"><?php echo e($view->start_date); ?></td>
			   <td class="tablesaw-priority-3"><?php echo e($view->end_date); ?></td>
			  <td class="tablesaw-priority-1">		
			  <a title="<?php echo e(trans('app.edit')); ?>" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo e(trans('app.edit')); ?>" class="btn btn-icon btn-info btn-outline btn-round" href="<?php echo e(url('productedit/'.'/'.$view->id)); ?>"><i class="icon wb-pencil" aria-hidden="true"></i> </a> 
				
				<button data-placement="top" data-toggle="modal" rel="tooltip" title="<?php echo e(trans('app.delete')); ?>"  data-original-title="<?php echo e(trans('app.delete')); ?>"  class="btn btn-icon btn-danger btn-outline btn-round" data-target=".exampleNiftyFlipVertical"  type="button" data-href="<?php echo e(URL::to('eventdestroy',$view->id)); ?>"><i class="icon fa-remove" aria-hidden="true"></i></button>
				</td>			
			</tr>
