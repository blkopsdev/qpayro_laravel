...
<form name="userForm" action="<?php echo e(URL::to('categoryupdate',$id)); ?>" ng-submit="submitForm(userForm.$valid)" novalidate  id="demo-form2" data-parsley-validate="" method="post" novalidate="" enctype="multipart/form-data">
	  ...
	  <!-- Example Basic Form -->	              
			...
			<p class="font-size-20 blue-grey-700">Category Details</p>
			  ...
			  <div class="form-group col-sm-6">
				...
				<input type="text" class="form-control" id="name" ng-model="name" name="category_name" ng-init="name='<?php echo e($categorydata->name); ?>'" placeholder="<?php echo e(trans('app.name')); ?>" required>
			  </div>
