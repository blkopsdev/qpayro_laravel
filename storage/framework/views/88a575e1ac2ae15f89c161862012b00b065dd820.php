...
<?php echo e(Form::open(array('url'=> URL::to('subscribers/submit'),'method' => 'post'))); ?>

<p>Simple Newsletter Subscription</p>
<?php echo e(Form::text('email',null,array('placeholder'=>'Type your E-mail address here'))); ?>
...
<?php echo e(HTML::script('http://code.jquery.com/jquery-1.8.3.min.js')); ?>
