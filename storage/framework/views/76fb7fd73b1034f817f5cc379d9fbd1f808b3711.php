...
<style>
	...
	.newsletter img:hover{
		content:url("<?php echo e(URL::to('images/newsletter_hover.png')); ?>");
	}
	</style>
			...
			<ul class="nav nav-tabs pull-right category-menu" data-plugin="nav-tabs" role="tablist">
				<?php 
					...
					if($certain_cate == 'all')
						$all_active = "active";
				 ?>	
				<li class="<?php echo e($all_active); ?>" style="width:300px;">
					<a class="overview"  href="<?php echo e(URL::to('frontspecial?cat=all')); ?>" style="font-size: 22px;" title="View Area Data">
						<i class="glyphicon glyphicon-th"></i> All 
					</a>
				</li>
				<?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $view): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<?php 
						$active = "";
						if($view->id==$certain_cate) $active = "active";
					 ?>
					<li  class="<?php echo e($active); ?>" style="width:300px;">						
						<a href="<?php echo e(URL::to('frontspecial?cat=')); ?><?php echo e($view->id); ?>" style="font-size: 20px;" title="Social Networks">
							<i class="fa "></i><?php echo e($view->name); ?>
						...
						<div class="container" style="width:95%;">
							<div id="myCarousel" class="carousel slide text-center" data-ride="carousel">
							    <div class="carousel-inner">
							    	<?php for($num=0;$num<$carousel_item_num;$num++): ?>
							    		<?php 
							    		 ...
							    		 ?>
							    	<div class="item <?php echo e($active); ?> aaaaaa">
							    		<?php for($i=$start;$i<$end;$i=$i+2): ?>
							    			<?php 
							    				$item1 = $i-1;
							    				$item2 = $i;
							    			 ?>
							    			<div class="inline-div">
							    				<img onclick="show_detail('<?php echo e($products[$item1]->name); ?>','<?php echo e($products[$item1]->text); ?>','/images/<?php echo e($products[$item1]->image); ?>','/videos/<?php echo e($products[$item1]->video); ?>');" class="img-rounded" src="/images/<?php echo e($products[$item1]->image); ?>">
							    				<img onclick="show_detail('<?php echo e($products[$item2]->name); ?>','<?php echo e($products[$item2]->text); ?>','/images/<?php echo e($products[$item2]->image); ?>','/videos/<?php echo e($products[$item1]->video); ?>');" class="img-rounded" src="/images/<?php echo e($products[$item2]->image); ?>">
							    			</div>
							    		<?php endfor; ?>
							    	</div>
							    	<?php endfor; ?>
	...
	<div class="row">
			<div class="col-lg-3 col-md-3 col-sm-12">
				<div class="newsletter">
					<img onclick="show_newsletter()" src="<?php echo e(URL::to('images/newsletter.png')); ?>">
				</div>	
			</div>
       		...
       		<div id="product-media-box" class="col-lg-5 col-md-5 col-sm-12 text-center">
	       		...
	       		<div id="product-video-box">
	       			<video id="product-video" width="400" controls>
	                      <source src="<?php echo e(URL::to('videos/mov_bbb.mp4')); ?>" type="video/mp4">
	                      <source src="<?php echo e(URL::to('videos/mov_bbb.ogg')); ?>" type="video/ogg">
	                </video>
	       		</div>
       		</div>     
       	</div>
         ...
         <?php  $cnt=0;  ?>      
         	...
         	<table class="table table-striped" style="color:black;" data-tablesaw-mode="columntoggle" >
         		<thead>
          		...
          		<tbody>
		            <?php $__currentLoopData = $newsletterlist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		            <?php  $cnt++;   ?>
...
<script type="text/javascript">	
	jQuery(function(){
		...
		$(".newsletter img").mouseover(function(){
			$(this).attr("src","<?php echo e(URL::to('images/newsletter_hover.png')); ?>");
		});
		$(".newsletter img").mouseout(function(){
			$(this).attr("src","<?php echo e(URL::to('images/newsletter.png')); ?>");
		});
	});
