...
<div class="page-header">
  <h1 class="page-title font_lato"><?php echo e(trans('app.create_new_category')); ?></h1>
</div>
...
<form name="userForm" action="<?php echo e(URL::to('categorystore',$id)); ?>" ng-submit="submitForm(userForm.$valid)" novalidate  id="demo-form2" data-parsley-validate="" method="post" novalidate="" enctype="multipart/form-data">
...
<div class="row row-lg">
	  ...
	  <!-- Example Basic Form -->	              
			...
			<p class="font-size-20 blue-grey-700">Category Details</p>
			  ...
			  <div class="form-group col-sm-6">
				...
				<input type="text" class="form-control" id="name" ng-model="first_name" name="category_name" ng-init="coupon_name='<?php echo e(old('coupon_name')); ?>'" placeholder="<?php echo e(trans('app.name')); ?>" required>
			  </div>
	...
	<div class="form-group col-sm-6">
	<a class="btn btn-default" href="http://israel.dev/product/<?php echo e($id); ?>">
