	  ...
	  <!-- Example Basic Form -->	              
			...
			<div class="row">			  
			  <div class="form-group col-sm-6">
				...
				<input type="file" class="form-control" id="upload-image" name="image"  value="" accept="image/x-png,image/gif,image/jpeg" placeholder="{{ trans('app.coupon_code')}}" required>
