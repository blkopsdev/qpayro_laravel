...
<div class="page-header">
  ...
  <ol class="breadcrumb">
		...
		@if (Auth::user()->hasRole('Admin'))<li><a href="{{URL::to('show')}}/{{$userdata->id}}">{{$userdata->first_name}} {{$userdata->last_name}}</a></li>@endif
	  ...
	  <!-- Example Basic Form -->
			...
			<div class="row">
			  ...
			  <div class="form-group col-sm-6">
				...
				<input type="text" class="form-control" id="phone" name="phone" placeholder="{{ trans('app.phone')}}" value="{{$userdata->email}}" autocomplete="off">
			  </div>
			</div>
			<div class="row">
			  <div class="form-group col-sm-6">
