...
<div class="page-header">
  ...
  <div class="page-header-actions">
	<ol class="breadcrumb">
		...
		<li class="active">Business: {{$userdata->business_id}} Payment Gateway: {{$userdata->payment_gateway_id}}</li>
	</ol>
  </div>
</div>
	  ...
	  <div class="widget widget-shadow text-center">
		<div class="widget-header">
		  <div class="widget-header-content">
			...
			<h4 class="profile-user">Business: {{$userdata->business_id}} Payment Gateway: {{$userdata->payment_gateway_id}}</h4>
		   <p class="profile-job">Estado - {{$userdata->status}}</p>
		  </div>
		</div>
...
<!------- Profile tab------------->
			...
			<table class="table table-hover table-details">
				...
				<tbody>
					<tr>
						...
						<td><a href="#">{{$userdata->product_id}}</a></td>
					</tr>
					<tr>
						<td>Audit Number</td>
						<td><a href="#">{{$userdata->audit_number}}</a></td>
					</tr>
				 </tbody>
			</table>
        ...
        <thead>
				...
				<tr>
					<td>CC Nombre</td>
					<td>{{$userdata->cc_name}}</td>
				</tr>
        <tr>
					<td>Ultimos cuatro digitos</td>
					<td>**** **** **** {{$userdata->cc_last4digits}}</td>
				</tr>

        <tr>
					<td>Fecha de expiración (Mes)</td>
					<td>{{$userdata->cc_expire_month}}</td>
				</tr>
        <tr>
					<td>Fecha de Expiracion (Año)</td>
					<td>{{$userdata->cc_expire_year}}</td>
				</tr>
        <thead>
				<tr>
        ...
        <tr>
					<td>Nombre</td>
					<td>{{$userdata->bill_to_name}}</td>
				</tr>
        <tr>
					<td>Impuesto</td>
					<td>{{$userdata->bill_to_tax_id}}</td>
				</tr>

        <tr>
					<td>Dirección</td>
					<td>{{$userdata->bill_to_address}}</td>
				</tr>
        <tr>
					<td>Ciudad</td>
					<td>{{$userdata->bill_to_city}}</td>
				</tr>

        <tr>
					<td>Estado</td>
					<td>{{$userdata->bill_to_state}}</td>
				</tr>
        <tr>
					<td>País</td>
					<td>{{$userdata->bill_to_country}}</td>
				</tr>


        <tr>
					<td>Codigo ZIP</td>
					<td>{{$userdata->bill_to_zip}}</td>
				</tr>
        <thead>
				<tr>
        ...
        <tr>
					<td>Request</td>
					<td>{{$userdata->request}}</td>
				</tr>
        <tr>
					<td>Codigo de Respuesta</td>
					<td>{{$userdata->response_code}}</td>
				</tr>
        <tr>
					<td>Texto de Respuesta</td>
					<td>{{$userdata->response_text}}</td>
				</tr>
        <tr>
					<td>Respuesta de Objeto</td>
					<td>{{$userdata->response_object}}</td>
				</tr>
        <tr>
					<td>Estado</td>
