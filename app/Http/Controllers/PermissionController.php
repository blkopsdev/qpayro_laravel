...
class PermissionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('roles_permission.permissions', compact('roles', 'permission','userdata1'));
    }
    ...
    {     $userdata1=User::all();
       ...
       return view('roles_permission.permission_edit',compact('permissiondata','userdata1'));
    }
